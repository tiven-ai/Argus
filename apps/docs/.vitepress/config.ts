...
export default defineConfig({
  ...
  // payload outside docs/, the excluded api/README, and example dev-server URLs.
  // Allow exactly those; all real in-portal links stay checked.
  ignoreDeadLinks: [/example-trace\.json$/, /\/api\/README$/, /^https?:\/\/localhost/],
})
