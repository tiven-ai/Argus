 ...
 *   user_message exists.
 * - `toolExecutions` are the execution spans (tool_call or external_resource)
 *   that ran after this LLM call's `tool_calls` output and before the next
 *   round's LLM call. They effectively become the trigger of the next round.
 */
